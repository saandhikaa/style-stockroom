...
@section('main')
    ...
    <ul class="flex space-x-2 mb-4">
        <li><a href="/dashboard/manage-products" class="inline-block bg-blue-500 text-white text-xs px-2 py-1 rounded-md">Back to All Products</a></li>
        <li><a href="/dashboard/manage-products/{{ $product->slug }}/edit" class="inline-block bg-green-500 text-white text-xs px-2 py-1 rounded-md">Edit</a></li>
        <li>
